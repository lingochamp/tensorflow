...
load("@patched_com_github_google_protobuf//:protobuf.bzl", "cc_proto_library")
...
def tf_proto_library_cc(name, srcs = [], has_services = None,
  ...
  cc_proto_library(
      name = name + "_cc",
      srcs = srcs,
      deps = tf_deps(protodeps, "_cc") + ["@patched_com_github_google_protobuf//:cc_wkt_protos"],
      cc_libs = cc_libs + ["@patched_com_github_google_protobuf//:protobuf"],
      copts = [
      ...
      default_runtime = "@patched_com_github_google_protobuf//:protobuf",
...
def tf_proto_library_py(name, srcs=[], protodeps=[], deps=[], visibility=[],
  ...
  py_proto_library(
      ...
      deps = deps + tf_deps(protodeps, "_py") + ["@patched_com_github_google_protobuf//:protobuf_python"],
      protoc = "@patched_com_github_google_protobuf//:protoc",
